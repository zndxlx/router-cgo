...
func (r *RouterRPC) Put(arg *proto.PutArg, reply *proto.PutReply) (err error) {
    reply.Seq, err = r.bucket(arg.UserId).Put(arg.UserId, arg.Server, arg.RoomId, arg.ClientIp, arg.ClientData)
    return
}

func (r *RouterRPC) Update(arg *proto.PutArg, reply *proto.PutReply) (err error) {
    if err = r.bucket(arg.UserId).Update(arg.UserId, arg.Server, arg.RoomId, arg.ClientIp, arg.ClientData); err != nil {
        log.Error("Update uid[%d] Data Error(%v)", arg.UserId, err)
    }
    return nil
}
...
func (r *RouterRPC) DelByUid(arg *proto.DelArg, reply *proto.DelReply) error {
    reply.Has = r.bucket(arg.UserId).DelByUid(arg.UserId)
    return nil
}
...
func (r *RouterRPC) GetWithAppid(arg *proto.GetWithAppidArg, reply *proto.GetReply) error {
    reply.Seqs, reply.Servers = r.bucket(arg.UserId).GetWithAppid(arg.UserId, arg.Appid)
    return nil
}

func (r *RouterRPC) GetInfo(arg *proto.GetArg, reply *proto.GetReply) error {
    reply.ClientInfo = r.bucket(arg.UserId).GetInfo(arg.UserId)
    log.Info("reply.ClientInfo=%+v", reply.ClientInfo)
    return nil
}
